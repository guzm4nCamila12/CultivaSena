...
export default function TransferirFInca() {
    ...
    return (
        <div className='text-center h-screen'>
            <Navbar />
            <h2 className='m-0 text-xl font-semibold p-2'>Transferir Fincas</h2>
            <div className='flex justify-center items-center pb-14 pt-5 w-[70%] rounded-3xl shadow-2xl m-auto min-h-[30%]'>
                ...
                <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center z-50">
                    <div className="bg-white flex flex-col rounded-3xl shadow-lg w-full sm:w-2/3 md:w-1/4 p-6 mx-4 my-8 sm:my-12">
                        ...
                        <div className="flex justify-between mt-6 space-x-4">
                            <button
                                className="w-full bg-red-600 hover:bg-[#021926] text-white font-bold py-3 rounded-full text-lg"
